...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
	...
	<form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>index.php/Buku/update_buku" role="form">
...
?>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" value="<?php echo $op['id_buku'];?>"  class="form-control" name="id_buku">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Judul</label>
                  <div class="col-sm-6">
                    <input type="text" value="<?php echo $op['stok'];?>" class="form-control" name="stok" placeholder="Stok Buku" >
                  </div>
                </div>
              <div class="col-sm-4">
              </div>
