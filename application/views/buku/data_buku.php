  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <?php echo 
                    '<div class="btn-group">
                    <a href="'.base_url().'index.php/Buku/detail_stok/?id_buku='.$op['id_buku'].'" class="btn btn-info" role="button" data-toggle="tooltip" title="Detail Stok"><i class="fa fa-list">View</i></a>
                    </div>
