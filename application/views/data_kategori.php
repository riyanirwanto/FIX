...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
    <h5 class="box-title"><i class="fa fa-book"></i> <center> Data Kategori</center></h5>
   ...
   <div class="btn-group"><a href="<?php echo base_url(); ?>index.php/kategori/create"  class="btn btn-success" role="button" 
    data-toggle="tooltip" title="Tambah Kategori"><i class="fa fa-plus"></i>  Tambah Kategori</a>

&nbsp&nbsp&nbsp&nbsp 

    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Cari Nama Kategori" title="Type in a name">
...
<a href="'.base_url().'index.php/Kategori/edit/?id_kategori='.$op['id_kategori'].'" class="btn btn-warning" role="button" 
data-toggle="tooltip" data-placement="top" title="Edit">Edit</i></a>
</span>



<a href="'.base_url().'index.php/Kategori/delete/?id_kategori='.$op['id_kategori'].'" class="btn btn-danger btn-ok" >Hapus</a>
