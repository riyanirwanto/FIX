...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
    <h5 class="box-title"><i class="fa fa-book"></i> <center>Data Pengarang</center></h5>
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>index.php/Pengarang/create"  class="btn btn-success" role="button" 
    data-toggle="tooltip" title="Tambah Pengarang"><i class="fa fa-plus"></i>  Tambah Pengarang</a>
&nbsp&nbsp&nbsp&nbsp 

    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Cari Nama Pengarang" title="Type in a name">
...
<a href="'.base_url().'index.php/Pengarang/edit/?id_pengarang='.$op['id_pengarang'].'" class="btn btn-warning" role="button" 
data-toggle="tooltip" data-placement="top" title="Edit">Edit</i></a>
</span>



<a href="'.base_url().'index.php/Pengarang/delete/?id_pengarang='.$op['id_pengarang'].'" class="btn btn-danger btn-ok" >Hapus</a>
