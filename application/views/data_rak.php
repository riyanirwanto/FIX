...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
    <h5 class="box-title"><i class="fa fa-book"></i> <center>Data Rak</center></h5>
   ...
   <div class="box-body">
   <div class="btn-group">
    <a href="<?php echo base_url(); ?>index.php/Rak/create"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Rak"><i class="fa fa-plus"></i>  Tambah Rak</a> &nbsp&nbsp&nbsp&nbsp 

    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Cari Kategori Rak" title="Type in a name">
...
<a href="'.base_url().'index.php/Rak/edit/?no_rak='.$op['no_rak'].'" class="btn btn-warning" role="button" 
data-toggle="tooltip" data-placement="top" title="Edit">Edit</i></a>
</span>



<a href="'.base_url().'index.php/Rak/delete/?no_rak='.$op['no_rak'].'" class="btn btn-danger btn-ok" >Hapus</a>
