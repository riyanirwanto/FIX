...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
    <h3 class="box-title"><i class="fa fa-plus"></i> <i class="fa fa-book"></i> Tambah pinjaman buku</h3>
  ...
  <form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>index.php/admin/updatedetnobuku" role="form">
              <div class="box-body">
