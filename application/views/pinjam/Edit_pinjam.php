...
<div class="box box-solid box-primary">
  ...
  <form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>index.php/admin/update/<?php echo $pinjam['id_pinjam'];?>" role="form">
              <div class="box-body">
              ...
              <div class="col-sm-4">
                  <div class="btn-group">
                    <a  href="<?php echo base_url(); ?>index.php/beranda/beranda_admin"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Kembali"></i>Back</a>
