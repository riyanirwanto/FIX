...
<div class="box box-solid box-primary">
  ...
  <form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>index.php/admin/createdet" role="form">
              <div class="box-body">
...
<select id="myselect" name="id_buku">
  <option value="">&nbsp;</option>
                  <?php 
                  foreach($this->Buku_model->getAllData("tb_buku")->result_array() as $op3)
                            {
                            ?>
