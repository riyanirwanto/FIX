...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
    <h5 class="box-title"><i class="fa fa-book"></i> <center>Daftar Penerbit</center></h5>
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>index.php/Penerbit/create"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Penerbit"><i class="fa fa-plus"></i>  Tambah Penerbit</a>
&nbsp&nbsp&nbsp&nbsp 

    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Cari Nama Penerbit" title="Type in a name">
...
<a href="'.base_url().'index.php/Penerbit/edit/?id_penerbit='.$op['id_penerbit'].'" class="btn btn-warning" role="button" 
data-toggle="tooltip" data-placement="top" title="Edit">Edit</i></a>
</span>



<a href="'.base_url().'index.php/Penerbit/delete/?id_penerbit='.$op['id_penerbit'].'" class="btn btn-danger btn-ok" >Hapus</a>
