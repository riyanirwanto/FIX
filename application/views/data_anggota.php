...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
    <h5 class="box-title"><i class="fa fa-book"></i> <center>Data Anggota</center></h5>
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>index.php/Anggota/create"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Anggota"><i class="fa fa-plus"></i>  Tambah Anggota</a> &nbsp&nbsp&nbsp&nbsp 

    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Cari Nama Anggota" title="Type in a name">
  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <td><img style="width: 70px; height: 70px;" src="<?php echo base_url('assets2/ktp_img/'.$op['image']) ?>"></td>
...
<a href="'.base_url().'index.php/Anggota/edit/?id_anggota='
.$op['id_anggota'].'" class="btn btn-warning" role="button" 
data-toggle="tooltip" data-placement="top" title="Edit">Edit</i></a>
</span>



<a href="'.base_url().'index.php/Delete/?id_anggota='.$op['id_anggota'].'" class="btn btn-danger btn-ok" >Hapus</a>
