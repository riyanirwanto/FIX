...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>index.php/Provinsi/create"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Provinsi"><i class="fa fa-plus"></i>  Tambah provinsi</a></div>
