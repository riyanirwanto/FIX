...
<div class="box box-solid box-primary">
  ...
  <form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>index.php/Anggota/update_data" role="form">
              <div class="box-body">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                   <textarea class="form-control" value="<?php echo $anggota['ket'];?>" name="keterangan" rows="4" placeholder="E Mail"><?php echo $anggota['ket'];?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="image">Upload File</label>
                  <input type="file" id="image" name="image" class="form-control-file <?php echo form_error('image') ? 'is-invalid' : '' ?>">
                  <input type="hidden" name="old_image" value="<?php echo $anggota['image']; ?>">
