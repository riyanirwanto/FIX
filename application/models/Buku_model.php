...
class Buku_model extends CI_Model
 {
	...
	function insertDataapriori($table,$data)
	{
		$this->db->insert($table,$data);
	}
	...
	function get_detail123($table,$id_table,$id) {
	 ...
	 function update_record($booking,$id)
{
    $this->db->where('id_denda', $id);
    $this->db->update('tb_denda', $booking);
}
